...
<div class="bg-primary text-white py-4 mb-5">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="fw-bold"><?php echo htmlspecialchars($category_info->name ?? 'Food & Cuisine Guides'); ?></h1>
                <p class="lead"><?php echo htmlspecialchars($category_info->description ?? 'Discover local flavors, culinary traditions, and gastronomic delights with expert food guides'); ?></p>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <?php if (!empty($category_info->image)): ?>
                    <img src="<?php echo url('public/img/categories/' . htmlspecialchars($category_info->image)); ?>" 
                         alt="<?php echo htmlspecialchars($category_info->name ?? 'Food Tours'); ?>" 
                         class="img-fluid rounded-3 shadow-lg" 
                         style="height: 250px; object-fit: cover; width: 100%;"
                         onerror="this.src='<?php echo url('public/img/category-food.jpg'); ?>'">
                <?php else: ?>
