    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                ...
                <p class="lead"><?php echo htmlspecialchars($category_info->description ?? 'Discover urban landscapes and hidden gems with our expert city tour guides'); ?></p>
            </div>
            <div class="col-lg-6 d-none d-lg-block">
                <?php if (!empty($category_info->image)): ?>
                    <img src="<?php echo url('public/img/categories/' . htmlspecialchars($category_info->image)); ?>" 
                         alt="<?php echo htmlspecialchars($category_info->name ?? 'City Tours'); ?>" 
                         class="img-fluid rounded-3 shadow-lg" 
                         style="height: 250px; object-fit: cover; width: 100%;"
                         onerror="this.src='<?php echo url('public/img/category-city.jpg'); ?>'">
                <?php else: ?>
