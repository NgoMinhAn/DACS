<div class="container py-4">
    ...
    <div class="mb-3">
        <a href="<?php echo url('guide/booking/' . $booking->id); ?>" class="btn btn-secondary btn-sm">Back to Booking</a>
    </div>
    <div class="card mb-3" style="max-height: 400px; overflow-y: auto;">
        <div class="card-body">
            <?php foreach ($messages as $msg): ?>
                <div class="mb-2">
                    <strong><?php echo $msg->sender_id == $currentUserId ? 'You' : 'Client'; ?>:</strong>
