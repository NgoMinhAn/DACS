    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow rounded-4">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo url('admin/addCategory'); ?>" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="name" class="form-label fw-bold">Category Name <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="name" name="name" required 
                                   placeholder="e.g., Adventure, Food, Cultural" value="<?php echo htmlspecialchars($_POST['name'] ?? ''); ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4" 
                                      placeholder="Describe what this category is about..."><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">
                                Upload an image for category card and banner header (JPG, JPEG, PNG, GIF - Max: 5MB). 
                                <strong class="text-info">This image will be used for both the category card and banner.</strong>
                            </small>
                            <div id="imagePreview" class="mt-2" style="display: none;">
                                <p class="text-muted mb-1"><small>Preview:</small></p>
