...
<style>
    .chat-page {
        ...
        align-items: center;
        gap: 18px;
        background: linear-gradient(135deg, #f2f3f7 0%, #d0d3db 100%);
    }
    .chat-page .chat-back-link {
        align-self: flex-start;
        margin-left: calc((100% - min(900px, 100%)) / 2);
    }
...
<div class="container py-4">
    <a href="<?php echo url('guide/booking/' . $booking->id); ?>" class="chat-back-link d-inline-flex align-items-center mb-3">
        <i class="fas fa-arrow-left me-2"></i> Quay lại chi tiết đặt tour
    </a>

    <div class="chat-wrapper">
        <div class="chat-header">
            <div class="chat-user">
                <img src="<?php echo htmlspecialchars($clientAvatar); ?>" alt="<?php echo htmlspecialchars($clientName); ?>">
                <div>
                    <div class="chat-username"><?php echo htmlspecialchars($clientName); ?></div>
                    <div class="chat-status offline" id="presenceStatus">
                        <span class="status-dot" id="presenceDot"></span>
                        <span id="presenceText">Khách hàng ngoại tuyến</span>
                    </div>
                </div>
            </div>
        ...
        <div class="chat-typing">
            <span id="typingIndicator" class="d-none">Client is typing...</span>
        </div>
...
<script>
    (function () {
        ...
        const otherUserId = <?php echo isset($booking->client_user_id) ? (int) $booking->client_user_id : 'null'; ?>;
        ...
        function appendMessage(data) {
            ...
            const label = isCurrentUser ? 'You' : 'Client';
