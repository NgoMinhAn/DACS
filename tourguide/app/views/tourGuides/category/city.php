...
<div class="category-hero-header position-relative overflow-hidden mb-5">
    ...
    <?php else: ?>
        <div class="category-hero-bg" style="background-image: url('<?php echo url('public/img/category-city.jpg'); ?>');"></div>
    <?php endif; ?>
                    ...
                    <div class="empty-state-container scroll-animate fade-up">
                        <div class="text-center py-5">
                            <div class="empty-state-icon mb-4">
                                <i class="fas fa-map-marked-alt" style="font-size: 5rem; color: #dee2e6;"></i>
                            </div>
...
<section class="mb-5">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="p-5 rounded-4 shadow-lg scroll-animate fade-up" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                    <div class="row align-items-center">
                        <div class="col-lg-8 mb-4 mb-lg-0">
                            <h3 class="fw-bold text-white mb-3">Looking for a Specialized City Experience?</h3>
                            <p class="lead mb-0 text-white">Tell us what you're interested in and we'll match you with the perfect city guide</p>
                        </div>
